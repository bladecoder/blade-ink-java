...
public class ConditionalSpecTest {
    ...
    public void ifTrue() throws Exception {
        ...
        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/conditional/iftrue.ink"));
    ...
    public void ifFalse() throws Exception {
        ...
        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/conditional/iffalse.ink"));
        Story story = new Story(json);
    ...
    /**
     * "- evaluate an else statement if it exists and no other condition evaluates
     * to true"
     */
    @Test
    public void ifElse() throws Exception {
        ...
        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/conditional/ifelse.ink"));
        Story story = new Story(json);
    ...
    /**
     * "- evaluate an extended else statement if it exists and no other condition
     * evaluates to true"
     */
    @Test
    public void ifElseExt() throws Exception {
        ...
        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/conditional/ifelse-ext.ink"));
        Story story = new Story(json);
    ...
    public void ifElseExtText1() throws Exception {
        ...
        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/conditional/ifelse-ext-text1.ink"));
        Story story = new Story(json);
    ...
    public void ifElseExtText2() throws Exception {
        ...
        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/conditional/ifelse-ext-text2.ink"));
        Story story = new Story(json);
    ...
    public void ifElseExtText3() throws Exception {
        ...
        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/conditional/ifelse-ext-text3.ink"));
        Story story = new Story(json);
    ...
    public void condText1() throws Exception {
        ...
        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/conditional/condtext.ink"));
        Story story = new Story(json);
    ...
    public void condText2() throws Exception {
        ...
        Assert.assertEquals(2, text.size());
        Assert.assertEquals(
                "I stared at Monsieur Fogg. \"But there must be a reason for this trip,\" I observed.", text.get(0));
    }
    ...
    public void condOpt1() throws Exception {
        ...
        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/conditional/condopt.ink"));
        Story story = new Story(json);
    ...
    /**
     * "- go through the alternatives and stick on last when the keyword is
     * stopping"
     */
    @Test
    public void stopping() throws Exception {
        ...
        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/conditional/stopping.ink"));
        Story story = new Story(json);
    ...
    public void cycle() throws Exception {
        ...
        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/conditional/cycle.ink"));
        Story story = new Story(json);
    ...
    /**
     * "- show each, once, in turn, until all have been shown when the keyword is
     * once"
     */
    @Test
    public void once() throws Exception {
        ...
        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/conditional/once.ink"));
        Story story = new Story(json);
    ...
    public void shuffle() throws Exception {
        ...
        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/conditional/shuffle.ink"));
        Story story = new Story(json);
    ...
    @Test
    public void shuffleStopping() throws Exception {
        List<String> text = new ArrayList<>();

        Compiler compiler = new Compiler();

        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/conditional/shuffle_stopping.ink"));
        Story story = new Story(json);
        ...
        TestUtils.nextAll(story, text);
        Assert.assertEquals(1, text.size());
        Assert.assertEquals("final", text.get(0));
        story.chooseChoiceIndex(0);
    ...
    @Test
    public void shuffleOnce() throws Exception {
        List<String> text = new ArrayList<>();

        Compiler compiler = new Compiler();

        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/conditional/shuffle_once.ink"));
        Story story = new Story(json);
    ...
    public void multiline() throws Exception {
        ...
        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/conditional/multiline.ink"));
        Story story = new Story(json);
    ...
    public void multilineDivert() throws Exception {
        ...
        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/conditional/multiline-divert.ink"));
        Story story = new Story(json);
    ...
    public void multilineChoice() throws Exception {
        ...
        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/conditional/multiline-choice.ink"));
        Story story = new Story(json);
