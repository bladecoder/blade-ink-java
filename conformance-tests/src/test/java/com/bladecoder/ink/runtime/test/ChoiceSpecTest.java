...
public class ChoiceSpecTest {
    ...
    public void noChoice() throws Exception {
        ...
        List<String> text = TestUtils.runStory("inkfiles/choices/no-choice-text.ink", null, errors);
    ...
    public void one() throws Exception {
        ...
        List<String> text = TestUtils.runStory("inkfiles/choices/one.ink", null, errors);
    ...
    public void multiChoice() throws Exception {
        ...
        List<String> text = TestUtils.runStory("inkfiles/choices/multi-choice.ink", Arrays.asList(0), errors);
        ...
        text = TestUtils.runStory("inkfiles/choices/multi-choice.ink", Arrays.asList(1), errors);
    ...
    public void singleChoice1() throws Exception {
        ...
        String json = TestUtils.compileInkFile("inkfiles/choices/single-choice.ink");
    ...
    public void suppressChoice() throws Exception {
        ...
        String json = TestUtils.compileInkFile("inkfiles/choices/suppress-choice.ink");
        Story story = new Story(json);
    ...
    public void mixedChoice() throws Exception {
        ...
        String json = TestUtils.compileInkFile("inkfiles/choices/mixed-choice.ink");
        Story story = new Story(json);
    ...
    public void varyingChoice() throws Exception {
        ...
        String json = TestUtils.compileInkFile("inkfiles/choices/varying-choice.ink");
        Story story = new Story(json);
        ...
        Assert.assertEquals(
                "The man with the briefcase?", story.getCurrentChoices().get(0).getText());
    }
    ...
    public void stickyChoice() throws Exception {
        ...
        String json = TestUtils.compileInkFile("inkfiles/choices/sticky-choice.ink");
        Story story = new Story(json);
    ...
    public void fallbackChoice() throws Exception {
        ...
        String json = TestUtils.compileInkFile("inkfiles/choices/fallback-choice.ink");
        Story story = new Story(json);
    ...
    public void conditionalChoice() throws Exception {
        ...
        String json = TestUtils.compileInkFile("inkfiles/choices/conditional-choice.ink");
        Story story = new Story(json);
    ...
    public void labelFlow() throws Exception {
        ...
        String json = TestUtils.compileInkFile("inkfiles/choices/label-flow.ink");
        Story story = new Story(json);
        ...
        Assert.assertEquals(2, story.getCurrentChoices().size());
        Assert.assertEquals(
                "\'Having a nice day?\'", story.getCurrentChoices().get(0).getText());
    }
    ...
    public void labelScope() throws Exception {
        ...
        String json = TestUtils.compileInkFile("inkfiles/choices/label-scope.ink");
        Story story = new Story(json);
        ...
        Assert.assertEquals(1, story.getCurrentChoices().size());
        Assert.assertEquals(
                "Found gatherpoint", story.getCurrentChoices().get(0).getText());
    }
    ...
    public void labelScopeError() throws Exception {
        ...
        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/choices/label-scope-error.ink"));
        //		Story story = new Story(json);
        //
        //		try {
        //			TestUtils.nextAll(story, text);
    ...
    public void divertChoice() throws Exception {
        ...
        String json = TestUtils.compileInkFile("inkfiles/choices/divert-choice.ink");
        Story story = new Story(json);
        ...
        Assert.assertEquals(1, story.getCurrentChoices().size());
        Assert.assertEquals(
                "Grapple and fight", story.getCurrentChoices().get(0).getText());
    }
}
