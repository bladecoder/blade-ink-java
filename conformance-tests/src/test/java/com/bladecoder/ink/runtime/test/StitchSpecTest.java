...
public class StitchSpecTest {
    ...
    public void autoStitch() throws Exception {
        ...
        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/stitch/auto-stitch.ink"));
    ...
    public void manualStitch() throws Exception {
        ...
        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/stitch/manual-stitch.ink"));
        Story story = new Story(json);
