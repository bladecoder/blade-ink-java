...
public class VariableTextSpecTest {
    ...
    public void sequence() throws Exception {
        ...
        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/variabletext/sequence.ink"));
    ...
    public void cycle() throws Exception {
        ...
        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/variabletext/cycle.ink"));
        Story story = new Story(json);
    ...
    public void once() throws Exception {
        ...
        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/variabletext/once.ink"));
        Story story = new Story(json);
    ...
    public void emptyElements() throws Exception {
        ...
        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/variabletext/empty-elements.ink"));
        Story story = new Story(json);
    ...
    public void listInChoice() throws Exception {
        ...
        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/variabletext/list-in-choice.ink"));
        Story story = new Story(json);
    ...
    public void one() throws Exception {
        ...
        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/variabletext/one.ink"));
        //		Story story = new Story(json);
        //
        //		TestUtils.nextAll(story, text);
        //		Assert.assertEquals(1, text.size());
    ...
    public void minusOne() throws Exception {
        ...
        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/variabletext/minus-one.ink"));
        //		Story story = new Story(json);
        //
        //		TestUtils.nextAll(story, text);
        //		Assert.assertEquals(1, text.size());
    ...
    public void ten() throws Exception {
        ...
        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/variabletext/ten.ink"));
        //		Story story = new Story(json);
        //
        //		TestUtils.nextAll(story, text);
        //		Assert.assertEquals(1, text.size());
