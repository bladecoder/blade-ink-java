...
public class GatherSpecTest {
    ...
    public void gatherBasic() throws Exception {
        ...
        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/gather/gather-basic.ink"));
    ...
    public void gatherChain() throws Exception {
        ...
        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/gather/gather-chain.ink"));
        Story story = new Story(json);
    ...
    public void nestedFlow() throws Exception {
        ...
        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/gather/nested-flow.ink"));
        Story story = new Story(json);
    ...
    public void deepNesting() throws Exception {
        ...
        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/gather/deep-nesting.ink"));
        Story story = new Story(json);
    ...
    public void complexFlow1() throws Exception {
        ...
        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/gather/complex-flow.ink"));
        Story story = new Story(json);
