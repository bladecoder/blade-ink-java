...
public class DivertSpec {
    ...
    public void simpleDivert() throws Exception {
        ...
        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/divert/simple-divert.ink"));
    ...
    public void invisibleDivert() throws Exception {
        ...
        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/divert/invisible-divert.ink"));
        Story story = new Story(json);
    ...
    public void divertOnChoice() throws Exception {
        ...
        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/divert/divert-on-choice.ink"));
        Story story = new Story(json);
    ...
    public void complexBranching1() throws Exception {
        ...
        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/divert/complex-branching.ink"));
        Story story = new Story(json);
