...
public class KnotSpecTest {
    ...
    public void testSingleLine() throws Exception {
        ...
        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/knot/single-line.ink"));
    ...
    public void testMultiLine() throws Exception {
        ...
        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/knot/multi-line.ink"));
        Story story = new Story(json);
    ...
    public void stripEmptyLines() throws Exception {
        ...
        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/knot/strip-empty-lines.ink"));
        Story story = new Story(json);
    ...
    public void paramStrings() throws Exception {
        ...
        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/knot/param-strings.ink"));
        Story story = new Story(json);
    ...
    public void paramInts() throws Exception {
        ...
        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/knot/param-ints.ink"));
        Story story = new Story(json);
    ...
    public void paramFloats() throws Exception {
        ...
        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/knot/param-floats.ink"));
        Story story = new Story(json);
    ...
    public void paramVars() throws Exception {
        ...
        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/knot/param-vars.ink"));
        Story story = new Story(json);
    ...
    public void paramMulti() throws Exception {
        ...
        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/knot/param-multi.ink"));
        Story story = new Story(json);
    ...
    public void paramRecurse() throws Exception {
        ...
        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/knot/param-recurse.ink"));
        Story story = new Story(json);
