...
public class VariableSpecTest {
    ...
    public void variableDeclaration() throws Exception {
        ...
        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/variable/variable-declaration.ink"));
    ...
    public void varCalc() throws Exception {
        ...
        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/variable/varcalc.ink"));
        Story story = new Story(json);
    ...
    public void varStringIncBug() throws Exception {
        ...
        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/variable/varstringinc.ink"));
        Story story = new Story(json);
    ...
    public void varDivert() throws Exception {
        ...
        String json = compiler.compile(TestUtils.readFileAsString("inkfiles/variable/var-divert.ink"));
        Story story = new Story(json);
