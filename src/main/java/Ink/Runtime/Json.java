...
public class Json {
	...
	static {
		try {
			_controlCommandNames = new String[(Ink.Runtime.ControlCommand.CommandType.TOTAL_VALUES).ordinal()];
			_controlCommandNames[Ink.Runtime.ControlCommand.CommandType.EvalStart.ordinal()] = "ev";
			_controlCommandNames[Ink.Runtime.ControlCommand.CommandType.EvalOutput.ordinal()] = "out";
			_controlCommandNames[Ink.Runtime.ControlCommand.CommandType.EvalEnd.ordinal()] = "/ev";
			_controlCommandNames[Ink.Runtime.ControlCommand.CommandType.Duplicate.ordinal()] = "du";
			_controlCommandNames[Ink.Runtime.ControlCommand.CommandType.PopEvaluatedValue.ordinal()] = "pop";
			_controlCommandNames[Ink.Runtime.ControlCommand.CommandType.PopFunction.ordinal()] = "~ret";
			_controlCommandNames[Ink.Runtime.ControlCommand.CommandType.PopTunnel.ordinal()] = "->->";
			_controlCommandNames[Ink.Runtime.ControlCommand.CommandType.BeginString.ordinal()] = "str";
			_controlCommandNames[Ink.Runtime.ControlCommand.CommandType.EndString.ordinal()] = "/str";
			_controlCommandNames[Ink.Runtime.ControlCommand.CommandType.NoOp.ordinal()] = "nop";
			_controlCommandNames[Ink.Runtime.ControlCommand.CommandType.ChoiceCount.ordinal()] = "choiceCnt";
			_controlCommandNames[Ink.Runtime.ControlCommand.CommandType.TurnsSince.ordinal()] = "turns";
			_controlCommandNames[Ink.Runtime.ControlCommand.CommandType.VisitIndex.ordinal()] = "visit";
			_controlCommandNames[Ink.Runtime.ControlCommand.CommandType.SequenceShuffleIndex.ordinal()] = "seq";
			_controlCommandNames[Ink.Runtime.ControlCommand.CommandType.StartThread.ordinal()] = "thread";
			_controlCommandNames[Ink.Runtime.ControlCommand.CommandType.Done.ordinal()] = "done";
			_controlCommandNames[Ink.Runtime.ControlCommand.CommandType.End.ordinal()] = "end";

			for (int i = 0; i < Ink.Runtime.ControlCommand.CommandType.TOTAL_VALUES.ordinal(); ++i) {
