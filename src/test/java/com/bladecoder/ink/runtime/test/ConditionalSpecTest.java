...
public class ConditionalSpecTest {
	...
	public void condText2() throws Exception {
		...
		TestUtils.nextAll(story, text);
		Assert.assertEquals(2, text.size());
		Assert.assertEquals("I stared at Monsieur Fogg. \"But there must be a reason for this trip,\" I observed.",
				text.get(0));
	}
	...
	public void shuffleStopping() throws Exception {
		...
		String json = TestUtils.getJsonString("inkfiles/conditional/shuffle_stopping.ink.json");
		Story story = new Story(json);
	...
	public void shuffleOnce() throws Exception {
		...
		String json = TestUtils.getJsonString("inkfiles/conditional/shuffle_once.ink.json");
		Story story = new Story(json);
